...
# 插入一条测试记录（未经过 MD5 的密码为 123456, 两次 MD5 后的密码为记录中的密码，两次 MD5 的 salt 一样）
INSERT INTO seckill_user (phone, nickname, password, salt)
VALUES (18888888888, 'IamXGW', '11602720aaaa0bcb09519f50aca8028b', '1a2b3c4d');
...
INSERT INTO `goods` VALUES
  (1, 'iphoneX', 'Apple iPhone X (A1865) 64GB 银色 移动联通电信4G手机', '/img/iphonex1.png','Apple iPhone X (A1865) 64GB 银色 移动联通电信4G手机', 8765.00, 1000),
...
INSERT INTO `seckill_goods` VALUES
  (1, 1, 0.01, 10, '2022-03-19 00:00:00', '2022-03-26 00:00:00'),
  (2, 2, 0.01, 10, '2022-03-25 00:00:00', '2022-03-26 00:00:00');
